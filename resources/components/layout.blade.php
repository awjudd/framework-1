...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="stylesheet" href="/vendor/haunt/css/app.css?v=8">
    </head>
    <body class="dark overflow-x-hidden overflow-y-scroll">
		<div class="bg-gray-150 max-h-screen min-h-screen text-gray-900 dark:bg-gray-850 dark:text-gray-100">
			<!-- navigation -->
